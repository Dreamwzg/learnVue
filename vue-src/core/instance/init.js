...
function resolveModifiedOptions(Ctor: Class < Component > ): ? Object {
    let modified
    const latest = Ctor.options //子构造器最全的属性
    const extended = Ctor.extendOptions //子构造器extend时传入的属性
    const sealed = Ctor.sealedOptions //融合父构造器(Vue)的options属性(没有被修改的时候的值)和extend的属性形成的子构造器的options
